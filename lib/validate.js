...
// ce's json codec round-trips JSON.stringify(value). It throws on bigints and
// circular refs, and a value that stringifies to `undefined` (a bare function,
// symbol, or undefined) has nothing to encode. A nested function is fine: like
// JSON itself, it is silently dropped, not thrown on.
...
set('none', () => true, '')
set('json', isJSONSerializable, 'must be JSON-serializable')
